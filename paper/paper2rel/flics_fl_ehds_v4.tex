% ============================================================================
% FL-EHDS Paper v4 for FLICS 2026 — 8-page submission
...
\vspace{1mm}
\footnotesize{4 hospitals, natural non-IID. Mean $\pm$ std over 10 seeds. FL: 20 rounds $\times$ 3 local epochs. $^\dagger$Local-Only AUC undefined: single-class test partitions at some hospitals prevent ROC computation. Extended results in Supplementary Material, Table~S-HeartDisease.}
\end{table}
