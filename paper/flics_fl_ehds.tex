...
Table~\ref{tab:main_results} presents FL algorithm comparison on Heart Disease and Diabetes. Table~\ref{tab:tabular_main} extends evaluation to PTB-XL, Cardiovascular, and Breast Cancer with 7 algorithms including FedLESAM and HPFL---1,230 total experiments across heterogeneity sweeps, client scaling, and learning rate sensitivity (see Supplementary Material, Section~S11).
