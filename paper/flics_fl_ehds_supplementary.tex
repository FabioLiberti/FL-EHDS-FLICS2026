...
This section provides a comprehensive technical specification of the FL-EHDS three-layer architecture, detailing all modules, services, protocols, and standards implemented in the reference framework. Figure~\ref{fig:architecture} in the main paper provides the high-level view; the description below enumerates every component with its specific technical parameters.
